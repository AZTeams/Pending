...
{
    const char* pszTimestamp = "The time of start xgoldcoin";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("880d33f7e55028d6df2709f559fe109291917c4e2065607f754a03146afb15ba");
        ...
        consensus.defaultAssumeValid = uint256S("0xc25fa35cc86928a491f9fe93a3e6df8e01ef6c4d958d0b254ec296b1badbd669"); //3
        ...
        genesis = CreateGenesisBlock(1510375200, 2803840, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x52a99a2e99fa641bac0f7f0d8e87742698b7687ec82743c32c5f5f46dc2b97a4"));
        assert(genesis.hashMerkleRoot == uint256S("0x7423c804db32b5d828a3378c2f1749a7ed44f183d2e780bd93fbb0e28cd06830"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("xgoldcoin.thecryptochat.net", "xgoldcoin.thecryptochat.net"));
        vSeeds.push_back(CDNSSeedData("103.229.192.161", "103.229.192.161"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  3, uint256S("0xc25fa35cc86928a491f9fe93a3e6df8e01ef6c4d958d0b254ec296b1badbd669")),
        };

        chainTxData = ChainTxData{
            // Data as of block 90e718e6878f4b7ae4de4ae83db75881d00ca017f5a117c2054798bcb76c4178 (height 1).
            1510392365, // * UNIX timestamp of last known number of transactions
