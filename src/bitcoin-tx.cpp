...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xgoldcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xgoldcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xgoldcoin transaction") + "\n" +
              "  xgoldcoin-tx [options] -create [commands]   " + _("Create hex-encoded xgoldcoin transaction") + "\n" +
              "\n";
